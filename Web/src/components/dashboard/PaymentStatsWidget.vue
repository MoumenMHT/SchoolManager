  ...
  <div class="col-span-12">
    <div class="grid grid-cols-12 gap-6">
      ...
      <div class="col-span-12 sm:col-span-6 xl:col-span-3">
        <div class="card h-full">
          <div class="flex items-center justify-between mb-4">
            <span class="text-sm font-medium text-muted-color">{{ t('dashboard.total_transactions') }}</span>
          ...
          <div class="text-sm text-muted-color mt-2">{{ t('dashboard.payments_recorded') }}</div>
        </div>
      </div>
      ...
      <div class="col-span-12 sm:col-span-6 xl:col-span-3">
        <div class="card h-full">
          <div class="flex items-center justify-between mb-4">
            <span class="text-sm font-medium text-muted-color">{{ t('dashboard.total_collected') }}</span>
          ...
          <div class="text-sm text-muted-color mt-2">{{ t('dashboard.completed_payments') }}</div>
        </div>
      </div>
      ...
      <div class="col-span-12 sm:col-span-6 xl:col-span-3">
        <div class="card h-full">
          <div class="flex items-center justify-between mb-4">
            <span class="text-sm font-medium text-muted-color">{{ t('dashboard.total_refunds') }}</span>
          ...
          <div class="text-sm text-muted-color mt-2">{{ t('dashboard.refunded_to_parents') }}</div>
        </div>
      </div>
      ...
      <div class="col-span-12 sm:col-span-6 xl:col-span-3">
        <div class="card h-full">
          <div class="flex items-center justify-between mb-4">
            <span class="text-sm font-medium text-muted-color">{{ t('dashboard.net_revenue') }}</span>
          ...
          <div class="text-sm text-muted-color mt-2">{{ t('dashboard.after_refunds') }}</div>
        </div>
      </div>
    </div>
  </div>
